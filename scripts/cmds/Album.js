...
module.exports = { 
  ...
  onReply: async function ({ api, event, Reply }) {
    ...
    try {
      ...
      api.sendMessage("❌ | 𝐅𝐚𝐢𝐥𝐞𝐝 𝐭𝐨 𝐝𝐨𝐰𝐧𝐥𝐨𝐚𝐝 𝐭𝐡𝐞 𝐯𝐢𝐝𝐞𝐨, 🥹error, contact siyam", event.threadID, event.messageID); }} catch (error) {
      api.sendMessage("🥹error, contact siyam.", event.threadID, event.messageID);
    }
  }
};
